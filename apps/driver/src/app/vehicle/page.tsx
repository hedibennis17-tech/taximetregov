...
export default function Page() {
  ...
  return (
    <AppShell>
      <div className="px-4 pt-4 pb-2"><h1 className="text-xl font-bold text-white">Mon véhicule</h1><p className="text-xs text-slate-400 mt-0.5">Données réelles · Supabase</p></div>
      <div className="px-4 pb-8 space-y-4">
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Mon véhicule</h2>
          {profile && (
