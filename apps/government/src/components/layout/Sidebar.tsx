...
import {
  ...
  Building, UserCog, Gauge, Brain, Clock, Truck
} from 'lucide-react'
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: '🔌 Plateformes', href: '/analytics/platforms', icon: Plug },
        ...
        { label: '🌐 Webhooks', href: '/analytics/webhooks', icon: Webhook },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Rapports fiscaux', href: '/reports/tax', icon: Percent },
        { label: 'Plateformes', href: '/reports/platform', icon: Plug },
        { label: 'Taxi', href: '/reports/taxi', icon: Car },
