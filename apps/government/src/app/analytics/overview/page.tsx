...
export default function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title="Analytiques — Vue globale" subtitle="Données Supabase · Table: revenue_ledger" />
      <div className="px-4 md:px-6 pb-8 space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-green-500/10 border border-green-500/20">
          ...
          <span className="text-xs text-green-400 font-semibold">
            Base de données connectée · Supabase PostgreSQL · Table: <code>revenue_ledger</code>
          </span>
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Analytiques — Vue globale</h2>
