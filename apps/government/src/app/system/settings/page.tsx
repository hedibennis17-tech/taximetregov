...
export default function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title="Configuration système" subtitle="Données Supabase · Table: system_configs" />
      <div className="px-4 md:px-6 pb-8 space-y-4">
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Configuration système</h2>
