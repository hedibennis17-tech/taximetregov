...
export default function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title="Centre d" subtitle="Données Supabase · Table: system_alerts" />
      <div className="px-4 md:px-6 pb-8 space-y-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-green-500/10 border border-green-500/20">
          ...
          <span className="text-xs text-green-400 font-semibold">
            Base de données connectée · Supabase PostgreSQL · Table: <code>system_alerts</code>
          </span>
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Centre d</h2>
