...
export default function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title="Opérations plateformes" subtitle="Données Supabase · Table: providers" />
      <div className="px-4 md:px-6 pb-8 space-y-4">
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Opérations plateformes</h2>
