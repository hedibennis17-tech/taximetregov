...
export default function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title="Centre de sécurité" subtitle="Données Supabase · Table: security_events" />
      <div className="px-4 md:px-6 pb-8 space-y-4">
        ...
        <Card className="p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Centre de sécurité</h2>
