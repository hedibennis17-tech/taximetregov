...
export const DEMO_TRANSACTIONS = [
  // Uber — courses individuelles réalistes Montréal/Laval
  { id:'TX-DEMO-1001', actId:'ACT-DEMO-001', whId:'WH-DEMO-0001', driver:'DEMO-DRV-001', provider:'UBER',      service:'UberX',      at:d('2026-09-17T08:41:00Z'), clientAmt:38.92,  base:24.75,  tip:4.00,  fee:4.95,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-001' },
  { id:'TX-DEMO-1002', actId:'ACT-DEMO-002', whId:'WH-DEMO-0002', driver:'DEMO-DRV-001', provider:'UBER',      service:'UberXL',     at:d('2026-09-17T07:22:00Z'), clientAmt:57.44,  base:36.50,  tip:5.00,  fee:7.30,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-001' },
  { id:'TX-DEMO-1003', actId:'ACT-DEMO-003', whId:'WH-DEMO-0003', driver:'DEMO-DRV-002', provider:'UBER',      service:'UberX',      at:d('2026-09-17T06:15:00Z'), clientAmt:29.83,  base:18.90,  tip:3.00,  fee:3.78,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-001' },
  { id:'TX-DEMO-1004', actId:'ACT-DEMO-004', whId:'WH-DEMO-0004', driver:'DEMO-DRV-001', provider:'UBER',      service:'Uber Black', at:d('2026-09-16T21:30:00Z'), clientAmt:87.61,  base:55.60,  tip:8.00,  fee:11.12, adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-001' },
  { id:'TX-DEMO-1005', actId:'ACT-DEMO-005', whId:'WH-DEMO-0005', driver:'DEMO-DRV-003', provider:'UBER',      service:'UberX',      at:d('2026-09-16T18:10:00Z'), clientAmt:33.67,  base:21.40,  tip:0,     fee:4.28,  adj:-2.50,refund:0,     period:'2026-Q3', status:'REVIEW_REQUIRED',  rec:'REC-DEMO-002' },
  // Lyft — courses individuelles
  { id:'TX-DEMO-1006', actId:'ACT-DEMO-006', whId:'WH-DEMO-0006', driver:'DEMO-DRV-001', provider:'LYFT',      service:'Standard',   at:d('2026-09-17T08:05:00Z'), clientAmt:31.48,  base:19.90,  tip:3.00,  fee:3.98,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-002' },
  { id:'TX-DEMO-1007', actId:'ACT-DEMO-007', whId:'WH-DEMO-0007', driver:'DEMO-DRV-002', provider:'LYFT',      service:'Standard',   at:d('2026-09-17T07:45:00Z'), clientAmt:22.16,  base:14.10,  tip:2.00,  fee:2.82,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-002' },
  { id:'TX-DEMO-1008', actId:'ACT-DEMO-008', whId:'WH-DEMO-0008', driver:'DEMO-DRV-001', provider:'LYFT',      service:'XL',         at:d('2026-09-16T20:00:00Z'), clientAmt:64.29,  base:40.80,  tip:5.00,  fee:8.16,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-002' },
  { id:'TX-DEMO-1009', actId:'ACT-DEMO-009', whId:'WH-DEMO-0009', driver:'DEMO-DRV-003', provider:'LYFT',      service:'Standard',   at:d('2026-09-16T15:30:00Z'), clientAmt:27.93,  base:17.80,  tip:0,     fee:3.56,  adj:0,    refund:-5.00, period:'2026-Q3', status:'REFUND_PROCESSED', rec:'REC-DEMO-002' },
  { id:'TX-DEMO-1010', actId:'ACT-DEMO-010', whId:'WH-DEMO-0010', driver:'DEMO-DRV-002', provider:'LYFT',      service:'Standard',   at:d('2026-09-16T12:20:00Z'), clientAmt:19.47,  base:12.40,  tip:1.50,  fee:2.48,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-002' },
  // TAXI — courses individuelles (pas de frais plateforme)
  { id:'TX-DEMO-1011', actId:'ACT-DEMO-011', whId:null,           driver:'DEMO-DRV-001', provider:'TAXI',      service:'Taxi std.',  at:d('2026-09-17T08:20:00Z'), clientAmt:42.80,  base:42.80,  tip:5.00,  fee:0,     adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-003' },
  { id:'TX-DEMO-1012', actId:'ACT-DEMO-012', whId:null,           driver:'DEMO-DRV-002', provider:'TAXI',      service:'Taxi std.',  at:d('2026-09-17T07:00:00Z'), clientAmt:58.40,  base:58.40,  tip:6.00,  fee:0,     adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-003' },
  { id:'TX-DEMO-1013', actId:'ACT-DEMO-013', whId:null,           driver:'DEMO-DRV-003', provider:'TAXI',      service:'Taxi acc.', at:d('2026-09-16T22:15:00Z'), clientAmt:35.60,  base:35.60,  tip:4.00,  fee:0,     adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-003' },
  { id:'TX-DEMO-1014', actId:'ACT-DEMO-014', whId:null,           driver:'DEMO-DRV-001', provider:'TAXI',      service:'Taxi std.',  at:d('2026-09-16T19:45:00Z'), clientAmt:27.20,  base:27.20,  tip:3.00,  fee:0,     adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-003' },
  { id:'TX-DEMO-1015', actId:'ACT-DEMO-015', whId:null,           driver:'DEMO-DRV-002', provider:'TAXI',      service:'Taxi std.',  at:d('2026-09-16T16:30:00Z'), clientAmt:31.80,  base:31.80,  tip:0,     fee:0,     adj:0,    refund:0,     period:'2026-Q3', status:'MISSING_TIP_DATA', rec:'REC-DEMO-004' },
  // DoorDash — livraisons individuelles
  { id:'TX-DEMO-1016', actId:'ACT-DEMO-016', whId:'WH-DEMO-0011', driver:'DEMO-DRV-001', provider:'DOORDASH',  service:'Livraison',  at:d('2026-09-17T12:30:00Z'), clientAmt:24.18,  base:14.80,  tip:3.00,  fee:2.96,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1017', actId:'ACT-DEMO-017', whId:'WH-DEMO-0012', driver:'DEMO-DRV-002', provider:'DOORDASH',  service:'Express',    at:d('2026-09-17T11:15:00Z'), clientAmt:18.43,  base:11.30,  tip:2.00,  fee:2.26,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1018', actId:'ACT-DEMO-018', whId:'WH-DEMO-0013', driver:'DEMO-DRV-001', provider:'DOORDASH',  service:'Livraison',  at:d('2026-09-17T10:00:00Z'), clientAmt:31.06,  base:19.00,  tip:4.00,  fee:3.80,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1019', actId:'ACT-DEMO-019', whId:'WH-DEMO-0014', driver:'DEMO-DRV-003', provider:'DOORDASH',  service:'Livraison',  at:d('2026-09-16T19:00:00Z'), clientAmt:14.92,  base:9.10,   tip:1.00,  fee:1.82,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1020', actId:'ACT-DEMO-020', whId:'WH-DEMO-0015', driver:'DEMO-DRV-001', provider:'DOORDASH',  service:'Livraison',  at:d('2026-09-16T14:30:00Z'), clientAmt:22.58,  base:13.80,  tip:2.50,  fee:2.76,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  // Instacart — livraisons épicerie
  { id:'TX-DEMO-1021', actId:'ACT-DEMO-021', whId:'WH-DEMO-0016', driver:'DEMO-DRV-002', provider:'INSTACART', service:'Épicerie',   at:d('2026-09-17T13:00:00Z'), clientAmt:46.73,  base:28.60,  tip:5.00,  fee:5.72,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1022', actId:'ACT-DEMO-022', whId:'WH-DEMO-0017', driver:'DEMO-DRV-003', provider:'INSTACART', service:'Express',    at:d('2026-09-16T11:00:00Z'), clientAmt:58.91,  base:36.10,  tip:6.00,  fee:7.22,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1023', actId:'ACT-DEMO-023', whId:'WH-DEMO-0018', driver:'DEMO-DRV-001', provider:'INSTACART', service:'Épicerie',   at:d('2026-09-15T14:30:00Z'), clientAmt:41.87,  base:25.60,  tip:3.00,  fee:5.12,  adj:0,    refund:0,     period:'2026-Q3', status:'AMOUNT_DIFFERENCE', rec:'REC-DEMO-004' },
  // Uber Eats — livraisons individuelles
  { id:'TX-DEMO-1024', actId:'ACT-DEMO-024', whId:'WH-DEMO-0019', driver:'DEMO-DRV-001', provider:'UBER_EATS', service:'Livraison',  at:d('2026-09-17T12:00:00Z'), clientAmt:28.64,  base:17.50,  tip:2.00,  fee:3.50,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1025', actId:'ACT-DEMO-025', whId:'WH-DEMO-0020', driver:'DEMO-DRV-002', provider:'UBER_EATS', service:'Livraison',  at:d('2026-09-17T09:30:00Z'), clientAmt:22.47,  base:13.70,  tip:1.50,  fee:2.74,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1026', actId:'ACT-DEMO-026', whId:'WH-DEMO-0021', driver:'DEMO-DRV-003', provider:'UBER_EATS', service:'Express',    at:d('2026-09-16T20:45:00Z'), clientAmt:35.29,  base:21.60,  tip:3.00,  fee:4.32,  adj:0,    refund:0,     period:'2026-Q3', status:'RECONCILED',       rec:'REC-DEMO-005' },
  { id:'TX-DEMO-1027', actId:'ACT-DEMO-027', whId:'WH-DEMO-0022', driver:'DEMO-DRV-001', provider:'UBER_EATS', service:'Livraison',  at:d('2026-09-16T18:00:00Z'), clientAmt:19.58,  base:12.00,  tip:0,     fee:2.40,  adj:0,    refund:0,     period:'2026-Q3', status:'MISSING_TIP_DATA', rec:'REC-DEMO-004' },
...
export const DEMO_RECONCILIATION = [
  { id:'REC-DEMO-001', provider:'UBER',      type:'MATCH',               expected:174.83, actual:174.83, diff:0,     status:'RECONCILED',     note:'Uber sem. 37-38 — 5 courses individuelles réconciliées · Pilote', period:'2026-Q3' },
  { id:'REC-DEMO-002', provider:'LYFT',      type:'TIP_DIFFERENCE',      expected:153.69, actual:151.19, diff:2.50,  status:'REVIEW_REQUIRED',note:'Écart pourboire — TX-DEMO-1005 — ajustement -2,50$ fournisseur vs driver · Pilote', period:'2026-Q3' },
  { id:'REC-DEMO-003', provider:'TAXI',      type:'MATCH',               expected:195.80, actual:195.80, diff:0,     status:'RECONCILED',     note:'Taxi QC — 5 courses sem. 37-38 · Données SAAQ/CTQ · Pilote', period:'2026-Q3' },
  { id:'REC-DEMO-004', provider:'INSTACART', type:'MISSING_TRANSACTION', expected:41.87,  actual:0,      diff:41.87, status:'OPEN',           note:'TX-DEMO-1023 — Payload Instacart non reçu via webhook sem. 36 — Pilote', period:'2026-Q3' },
  { id:'REC-DEMO-005', provider:'UBER_EATS', type:'REFUND_ADJUSTMENT',   expected:153.19, actual:148.19, diff:5.00,  status:'RESOLVED',       note:'TX-DEMO-1009 — Remboursement -5,00$ Lyft traité et confirmé · Pilote', period:'2026-Q3' },
]
