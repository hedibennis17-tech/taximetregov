    ...
    <AppShell>
      <div className="px-4 md:px-6 py-6 space-y-5 max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm overflow-hidden">
          ...
          {[{at:'2026-09-18T10:38:00Z',user:'Sophie Marchand',action:'SYNC_COMPLETED',obj:'Revenue Ledger',result:'9 840 enr.'},{at:'2026-09-18T10:00:00Z',user:'SYSTÈME',action:'TRIP_TRANSMITTED',obj:'TRIP-001',result:'TX-001 créé'},{at:'2026-09-17T14:00:00Z',user:'Jean-Philippe Roy',action:'REPORT_EXPORTED',obj:'Revenus Q2',result:'PDF généré'},{at:'2026-09-16T10:00:00Z',user:'Sophie Marchand',action:'DOCUMENT_UPLOADED',obj:'DOC-003',result:'En attente validation'}].map((a,i)=>(
